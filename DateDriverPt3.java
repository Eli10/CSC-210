...
class Date {
     ...
     public static int daysInAMonth(int year, int month) {
      ...
      public static int determineMonthFromJulianDate(int days) {
         ...
         int year = determineYearFromJulianDate(days);
         ...
         for(month = month; days > daysInAMonth(year, month); month++) {
            days = days - daysInAMonth(year, month);
         }
         return month;
      ...
      public static int determineDayFromJulianDate(int days) {
         ...
         if (days >= daysInAMonth(year, month)) {
            days = days - daysInAMonth(determineYearFromJulianDate(days), determineMonthFromJulianDate(days));
         }
